const myData = [
  {
    title: "Work",
    idSection: "work-section",
    svgSection: `<svg width="79" height="79" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  {
    title: "Play",
    idSection: "play-section",
    svgSection: `<svg width="76" height="77" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  {
    title: "Exercise",
    idSection: "exercice-section",
    svgSection: `<svg id="exercice-svg" width="81" height="55" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  {
    title: "Social",
    idSection: "social-section",
    svgSection: `<svg width="75" height="100" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: "Self Care",
    idSection: "care-section",
    svgSection: `<svg width="67" height="67" xmlns="http://www.w3.org/2000/svg">
    <path
...
dailyLink.addEventListener("click", function (event) {
  ...
  dailyLink.classList.replace("inactive","active");
  weeklyLink.classList.replace("active","inactive");
  monthlyLink.classList.replace("active","inactive");
  createNewCard("daily");
});

weeklyLink.addEventListener("click", function (event) {
  event.preventDefault();
  dailyLink.classList.replace("active","inactive");
  weeklyLink.classList.replace("inactive","active");
  monthlyLink.classList.replace("active","inactive");
  createNewCard("weekly");
});
...
monthlyLink.addEventListener("click", function (event) {
  ...
  dailyLink.classList.replace("active","inactive");
  weeklyLink.classList.replace("active","inactive");
  monthlyLink.classList.replace("inactive","active");
  createNewCard("monthly");
});

function createInitialCard(duration) {
